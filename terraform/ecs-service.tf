locals {
  ...
  ecs_task_sg_ids = var.allow_vpn_to_ecs_tasks ? [aws_security_group.ecs-tasks-sg.id, aws_security_group.vpn_to_gp_to_repo_ecs[0].id] : [aws_security_group.ecs-tasks-sg.id]
